  ...
  return /******/function () {
    ...
    var __webpack_modules__ = {
      ...
      /*!***********************!*\
        ...
        \***********************/
      /***/
      function _src_ConfigJs(module, __unused_webpack_exports, __webpack_require__) {
        var __dirname = "/";
        function _typeof(o) {
        ...
        var _require = __webpack_require__(/*! fast-xml-parser */"fast-xml-parser"),
        ...
        _defineProperty(Config, "builder", new XMLBuilder(builderOptions));
      ...
      /*!********************!*\
        ...
        \********************/
      /***/
      function _src_XULJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var EventManager = __webpack_require__(/*! ./core/EventManager */"./src/core/EventManager.js");
        ...
        var XUL = /*#__PURE__*/function () {
          ...
          return _createClass(XUL, [{
            ...
            value: function updateControl(id, label, attributes, items) {
              var triggerEvent = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
              var origionalControl = this.controlManager.getControl(id);
              if (!origionalControl) {
                throw new Error("Control with id ".concat(id, " not found"));
              }
            ...
            key: "addEvent",
            value: function addEvent(eventType, controlId, handler) {
              var origionalControl, newAttributes;
              switch (eventType) {
            ...
            key: "_onlyFunctionBody",
            value: function _onlyFunctionBody(func) {
              // 源码
              var handlerString = func.toString();
              // 使用正则表达式提取函数体内容
            ...
            value: function factory(props) {
              ...
              if (_typeof(props) === 'object' && props.name && props.params) {
                props.params.forEach(function (param) {
                  var id = props.name + '_' + param;
                  xul.addTextbox(param, id);
                });
                xul.title = "Dialog for \"".concat(props.name, "\"");
                return xul;
              } else {
      ...
      /*!********************************************!*\
        ...
        \********************************************/
      /***/
      function _src_controls_Flash_FlashControlJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var XULControl = __webpack_require__(/*! ../../core/XULControl */"./src/core/XULControl.js");
        ...
        var FlashControl = /*#__PURE__*/function (_XULControl) {
          function FlashControl(id, xul, xml, attributes) {
            ...
            return _callSuper(this, FlashControl, ['flash', id, '', xul, xml, attributes]);
          }
          ...
          return _createClass(FlashControl, [{
            ...
            value: function _updateXmlAttribute(attrName, value) {
              var customType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.type;
              try {
      ...
      /*!************************************************!*\
        ...
        \************************************************/
      /***/
      function _src_controls_compound_CheckboxGroupJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var CheckboxGroup = /*#__PURE__*/function (_XULControl) {
          function CheckboxGroup(id, label, xul, xml, attributes, items) {
            _classCallCheck(this, CheckboxGroup);
            return _callSuper(this, CheckboxGroup, ['checkboxgroup', id, label, xul, xml, attributes, items]);
          }
          ...
          return _createClass(CheckboxGroup, [{
            ...
            value: function toString() {
              return "CheckboxGroup(id=".concat(this.id, ", label=").concat(this._label, ", groupbox=").concat(this._groupbox, ", items=").concat(this.items.map(function (item) {
                return item.label;
              }), ")");
            }
          }, {
            ...
            value: function _setNewItems(items) {
              var customType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.type;
              _superPropGet(CheckboxGroup, "_setNewItems", this, 3)([items, "vbox"]);
            }
          }, {
            key: "_updateXmlAttribute",
            value: function _updateXmlAttribute(attrName, value) {
              var customType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : this.type;
              _superPropGet(CheckboxGroup, "_updateXmlAttribute", this, 3)([attrName, value, "vbox"]);
            }
          }]);
        }(XULControl);
      ...
      /*!******************************************!*\
        ...
        \******************************************/
      /***/
      function _src_controls_compound_ListBoxJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var ListBox = /*#__PURE__*/function (_XULControl) {
          function ListBox(id, label, xul, xml, attributes, items) {
            ...
            return _callSuper(this, ListBox, ['listbox', id, label, xul, xml, attributes, items]);
          }
          ...
          return _createClass(ListBox, [{
            ...
            key: "toString",
            value: function toString() {
              return "ListBox(id=".concat(this.id, ", label=").concat(this._label, ", width=").concat(this._width, ", flex=").concat(this._flex, ", rows=").concat(this._rows, ", tabindex=").concat(this._tabindex, ", items=").concat(this.items.map(function (item) {
                return item.label;
              }), ")");
            }
          }]);
      ...
      /*!*******************************************!*\
        ...
        \*******************************************/
      /***/
      function _src_controls_compound_MenuListJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var MenuList = /*#__PURE__*/function (_XULControl) {
          function MenuList(id, label, xul, xml, attributes, items) {
            ...
            return _callSuper(this, MenuList, ['menulist', id, label, xul, xml, attributes, items]);
          }
          ...
          return _createClass(MenuList, [{
            ...
            key: "toString",
            value: function toString() {
              return "MenuList(id=".concat(this.id, ", label=").concat(this._label, ", width=").concat(this._width, ", flex=").concat(this._flex, ", tabindex=").concat(this._tabindex, ", editable=").concat(this._editable, ", oncreate=").concat(this._oncreate, ", onsetfocus=").concat(this._onsetfocus, ", items=").concat(this.items.map(function (item) {
                return item.label;
              }), ")");
            }
          }, {
            ...
            value: function _setNewItems(items) {
              ...
              var childrenType = this._getChildrenType(this.type);
      ...
      /*!*********************************************!*\
        ...
        \*********************************************/
      /***/
      function _src_controls_compound_RadioGroupJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var RadioGroup = /*#__PURE__*/function (_XULControl) {
          function RadioGroup(id, label, xul, xml, attributes, items) {
            ...
            return _callSuper(this, RadioGroup, ['radiogroup', id, label, xul, xml, attributes, items]);
          }
          ...
          return _createClass(RadioGroup, [{
            ...
            key: "toString",
            value: function toString() {
              return "RadioGroup(id=".concat(this.id, ", label=").concat(this._label, ", tabindex=").concat(this._tabindex, ", groupbox=").concat(this._groupbox, ", items=").concat(this.items.map(function (item) {
                return item.label;
              }), ")");
            }
          }]);
      ...
      /*!********************************************!*\
        ...
        \********************************************/
      /***/
      function _src_controls_nonvisual_PropertyJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Property = /*#__PURE__*/function (_XULControl) {
          function Property(id, xul, xml) {
            ...
            return _callSuper(this, Property, ['property', id, '', xul, xml]);
          }
      ...
      /*!******************************************!*\
        ...
        \******************************************/
      /***/
      function _src_controls_nonvisual_ScriptJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Script = /*#__PURE__*/function (_XULControl) {
          function Script(id, xul, xml, attributes) {
            ...
            return _callSuper(this, Script, ['script', id, '', xul, xml, attributes]);
          }
          ...
          return _createClass(Script, [{
            ...
            value: function _setNewAttributes() {
              ...
              var doc = this.domParser.parseFromString(this.xml, 'text/xml');
              ...
              if (scriptNode) {
                ...
                for (var i = 0; i < scriptNode.childNodes.length; i++) {
                  if (scriptNode.childNodes[i].nodeType === 4) {
                    // CDATA_SECTION_NODE
                    existingContent += scriptNode.childNodes[i].data;
                  } else if (scriptNode.childNodes[i].nodeType === 3) {
                    // TEXT_NODE
                ...
                // 创建新的 CDATA 节点并添加内容
                var cdataNode = doc.createCDATASection(newContent);
                scriptNode.appendChild(cdataNode);
              }
              var updatedXml = this.serializer.serializeToString(doc);
      ...
      /***/"./src/controls/nonvisual/Separator.js": (
      /*!*********************************************!*\
        !*** ./src/controls/nonvisual/Separator.js ***!
        \*********************************************/
      /***/
      function _src_controls_nonvisual_SeparatorJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var XULControl = __webpack_require__(/*! ../../core/XULControl */"./src/core/XULControl.js");
        var Separator = /*#__PURE__*/function (_XULControl) {
          function Separator(id, xul, xml) {
            _classCallCheck(this, Separator);
            return _callSuper(this, Separator, ['separator', id, '', xul, xml]);
          }
          _inherits(Separator, _XULControl);
      ...
      /***/"./src/controls/nonvisual/Spacer.js": (
      /*!******************************************!*\
        !*** ./src/controls/nonvisual/Spacer.js ***!
        \******************************************/
      /***/
      function _src_controls_nonvisual_SpacerJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var XULControl = __webpack_require__(/*! ../../core/XULControl */"./src/core/XULControl.js");
        var Spacer = /*#__PURE__*/function (_XULControl) {
          function Spacer(id, xul, xml) {
            _classCallCheck(this, Spacer);
            return _callSuper(this, Spacer, ['spacer', id, '', xul, xml]);
          }
          _inherits(Spacer, _XULControl);
      ...
      /*!***************************************!*\
        ...
        \***************************************/
      /***/
      function _src_controls_simple_ButtonJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Button = /*#__PURE__*/function (_XULControl) {
          function Button(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, Button, ['button', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(Button, [{
            ...
            key: "toString",
            value: function toString() {
              return "Button(label=".concat(this._label, ", width=").concat(this._width, ", flex=").concat(this._flex, ", tabindex=").concat(this._tabindex, ", acceskey=").concat(this._acceskey, ", oncommand=").concat(this._oncommand, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!*****************************************!*\
        ...
        \*****************************************/
      /***/
      function _src_controls_simple_CheckboxJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Checkbox = /*#__PURE__*/function (_XULControl) {
          function Checkbox(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, Checkbox, ['checkbox', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(Checkbox, [{
            ...
            key: "toString",
            value: function toString() {
              return "Checkbox(checked=".concat(this._checked, ", tabindex=").concat(this._tabindex, ", acceskey=").concat(this._acceskey, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!*******************************************!*\
        ...
        \*******************************************/
      /***/
      function _src_controls_simple_ChooseFileJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var ChooseFile = /*#__PURE__*/function (_XULControl) {
          function ChooseFile(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, ChooseFile, ['choosefile', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(ChooseFile, [{
            ...
            key: "toString",
            value: function toString() {
              return "ChooseFile(literal=".concat(this._literal, ", pathtype=").concat(this._pathtype, ", required=").concat(this._required, ", size=").concat(this._size, ", type=").concat(this._type, ", width=").concat(this._width, ", flex=").concat(this._flex, ", tabindex=").concat(this._tabindex, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!******************************************!*\
        ...
        \******************************************/
      /***/
      function _src_controls_simple_ColorchipJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Colorchip = /*#__PURE__*/function (_XULControl) {
          function Colorchip(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, Colorchip, ['colorchip', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(Colorchip, [{
            ...
            key: "toString",
            value: function toString() {
              return "Colorchip(color=".concat(this._color, ", format=").concat(this._format, ", width=").concat(this._width, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!**************************************!*\
        ...
        \**************************************/
      /***/
      function _src_controls_simple_LabelJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Label = /*#__PURE__*/function (_XULControl) {
          function Label(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, Label, ['label', id, label, xul, xml, attributes]);
          }
      ...
      /*!********************************************!*\
        ...
        \********************************************/
      /***/
      function _src_controls_simple_PopupSliderJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var PopupSlider = /*#__PURE__*/function (_XULControl) {
          function PopupSlider(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, PopupSlider, ['popupslider', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(PopupSlider, [{
            ...
            key: "toString",
            value: function toString() {
              return "PopupSlider(value=".concat(this._value, ", minvalue=").concat(this._minvalue, ", maxvalue=").concat(this._maxvalue, ", orientation=").concat(this._orientation, ", tabindex=").concat(this._tabindex, ", width=").concat(this._width, ", flex=").concat(this._flex, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!*******************************************!*\
        ...
        \*******************************************/
      /***/
      function _src_controls_simple_TargetListJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var TargetList = /*#__PURE__*/function (_XULControl) {
          function TargetList(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, TargetList, ['targetlist', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(TargetList, [{
            ...
            key: "toString",
            value: function toString() {
              return "TargetList(width=".concat(this._width, ", height=").concat(this._height, ", flex=").concat(this._flex, ", pathtype=").concat(this._pathtype, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!****************************************!*\
        ...
        \****************************************/
      /***/
      function _src_controls_simple_TextBoxJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Textbox = /*#__PURE__*/function (_XULControl) {
          function Textbox(id, label, xul, xml, attributes) {
            ...
            return _callSuper(this, Textbox, ['textbox', id, label, xul, xml, attributes]);
          }
          ...
          return _createClass(Textbox, [{
            ...
            value: function validate() {
              ...
              if (this._required && !value.trim()) {
                return "Field \"".concat(this.id, "\" is required");
              }
              if (this._maxLength && value.length > this._maxLength) {
                return "Text exceeds maximum length of ".concat(this._maxLength, " characters");
              }
              if (this._pattern && !new RegExp(this._pattern).test(value)) {
                return "Invalid format for field \"".concat(this.id, "\"");
              }
              return null;
            }
            ...
            key: "toString",
            value: function toString() {
              return "Textbox (id=\"".concat(this.id, "\" value=\"").concat(this.value, "\" multiline=").concat(this.multiline, " maxLength=").concat(this.maxLength, " prompt=\"").concat(this.prompt, "\" size=").concat(this.size, " width=").concat(this.width, " flex=").concat(this.flex, ")");
            }
          }]);
        }(XULControl);
      ...
      /*!************************************!*\
        ...
        \************************************/
      /***/
      function _src_core_ControlFactoryJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var Textbox = __webpack_require__(/*! ../controls/simple/TextBox */"./src/controls/simple/TextBox.js");
        var Colorchip = __webpack_require__(/*! ../controls/simple/Colorchip */"./src/controls/simple/Colorchip.js");
        var PopupSlider = __webpack_require__(/*! ../controls/simple/PopupSlider */"./src/controls/simple/PopupSlider.js");
        var Checkbox = __webpack_require__(/*! ../controls/simple/Checkbox */"./src/controls/simple/Checkbox.js");
        var Button = __webpack_require__(/*! ../controls/simple/Button */"./src/controls/simple/Button.js");
        var TargetList = __webpack_require__(/*! ../controls/simple/TargetList */"./src/controls/simple/TargetList.js");
        var ChooseFile = __webpack_require__(/*! ../controls/simple/ChooseFile */"./src/controls/simple/ChooseFile.js");
        var ListBox = __webpack_require__(/*! ../controls/compound/ListBox */"./src/controls/compound/ListBox.js");
        var MenuList = __webpack_require__(/*! ../controls/compound/MenuList */"./src/controls/compound/MenuList.js");
        var RadioGroup = __webpack_require__(/*! ../controls/compound/RadioGroup */"./src/controls/compound/RadioGroup.js");
        var CheckboxGroup = __webpack_require__(/*! ../controls/compound/CheckboxGroup */"./src/controls/compound/CheckboxGroup.js");
        var XULControl = __webpack_require__(/*! ./XULControl */"./src/core/XULControl.js");
        var Property = __webpack_require__(/*! ../controls/nonvisual/Property */"./src/controls/nonvisual/Property.js");
        var FlashControl = __webpack_require__(/*! ../controls/Flash/FlashControl */"./src/controls/Flash/FlashControl.js");
        var Label = __webpack_require__(/*! ../controls/simple/Label */"./src/controls/simple/Label.js");
        var Script = __webpack_require__(/*! ../controls/nonvisual/Script */"./src/controls/nonvisual/Script.js");
        var Separator = __webpack_require__(/*! ../controls/nonvisual/Separator */"./src/controls/nonvisual/Separator.js");
        var Spacer = __webpack_require__(/*! ../controls/nonvisual/Spacer */"./src/controls/nonvisual/Spacer.js");
        ...
        var ControlFactory = /*#__PURE__*/function () {
          ...
          return _createClass(ControlFactory, null, [{
            key: "create",
            value: function create(type, id, label, xul, xml, attributes, items) {
              switch (type) {
                // simple controls
                case 'label':
                ...
                default:
                  throw new Error("Unsupported control type: ".concat(type));
              }
            }
          }]);
        }();
      ...
      /*!************************************!*\
        ...
        \************************************/
      /***/
      function _src_core_ControlManagerJs(module) {
        function _typeof(o) {
          "@babel/helpers - typeof";
          ...
          return _createClass(ControlManager, [{
            ...
            value: function addControl(control) {
              ...
              if (this.controls[control.id]) {
                throw new Error("Control with id ".concat(control.id, " already exists"));
              }
      ...
      /*!***********************************!*\
        ...
        \***********************************/
      /***/
      function _src_core_DialogBuilderJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var DialogBuilder = /*#__PURE__*/function () {
          ...
          return _createClass(DialogBuilder, [{
            ...
            value: function build(title, content, columns) {
              ...
              // 添加内容
              var contentObj = this.parser.parse("<rows>".concat(content, "</rows>"));
            ...
            value: function _setColumnWidths(xmlObj, columns) {
              var doc = this.domParser.parseFromString(this.builder.build(xmlObj), 'text/xml');
              var labels = xpath.select('//label', doc);
              labels.forEach(function (label) {
                return label.setAttribute('width', columns[0]);
              });
              var controls = xpath.select('//*[@class="control"]', doc);
              controls.forEach(function (control) {
                return control.setAttribute('width', columns[1]);
              });
            ...
            value: function _loadControlTemplates() {
              ...
              var doc = this.domParser.parseFromString(xml, 'text/xml');
      ...
      /*!**********************************!*\
        ...
        \**********************************/
      /***/
      function _src_core_EventManagerJs(module, __unused_webpack_exports, __webpack_require__) {
        function _typeof(o) {
          "@babel/helpers - typeof";
        ...
        var EventEmitter = __webpack_require__(/*! eventemitter3 */"eventemitter3");
        ...
        var XULEvent = /*#__PURE__*/_createClass(function XULEvent(type, control, xul) {
        ...
        var EventManager = /*#__PURE__*/function () {
          ...
          return _createClass(EventManager, [{
            key: "add",
            value: function add(eventType, controlId, handler) {
              var eventName = this.getEventName(eventType, controlId);
              this.emitter.on(eventName, handler);
            }
          }, {
            key: "getEventName",
            value: function getEventName(eventType, controlId) {
              return "".concat(eventType, ":").concat(controlId);
            }
            ...
            key: "trigger",
            value: function trigger(eventType, controlId, eventData) {
              var eventName = this.getEventName(eventType, controlId);
              var control = this.xul.controlManager.getControl(controlId);
              var event = new XULEvent(eventType, control, this.xul);
      ...
      /*!********************************!*\
        ...
        \********************************/
      /***/
      function _src_core_XULControlJs(module, __unused_webpack_exports, __webpack_require__) {
        function _slicedToArray(r, e) {
          return _arrayWithHoles(r) || _iterableToArrayLimit(r, e) || _unsupportedIterableToArray(r, e) || _nonIterableRest();
        }
        function _nonIterableRest() {
        ...
        var XULControl = /*#__PURE__*/function () {
          function XULControl(type, id, label, xul, xml, attributes, items) {
          ...
          return _createClass(XULControl, [{
            ...
            value: function _getChildrenType(parentType) {
              switch (parentType) {
                ...
                case "listbox":
                  return "listitem";
                default:
                  throw new Error("Invalid parent type: ".concat(parentType));
              }
            }
            ...
            value: function _initItems(items) {
              ...
              return items.map(function (item) {
                if (typeof item === "string") {
                  ...
                  // 提取解析后的属性值，并转换为所需的格式
                  var childrenType = _this._getChildrenType(_this.type);
            ...
            key: "toString",
            value: function toString() {
              return "[object XULControl id=\"".concat(this.id, "\" type=\"").concat(this.type, "\"]");
            }
            ...
            value: function _updateXmlAttribute(attrName, value) {
              ...
              try {
                ...
                var xmlObj = this.parser.parse(this.xml);
                xmlObj.row[customType]["@_".concat(attrName)] = String(value);
                // console.log(xmlObj);
                this.xml = this.builder.build(xmlObj);
