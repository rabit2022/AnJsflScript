...
define(function () {
    ...
    const JSFLNumerics = {
        ...
        frame: {
             ...
             */
            frameRate: {
                FPS: 30, // 每秒帧数（Frames Per Second）
                FPM: 30 * 60, // 每分钟帧数（Frames Per Minute）
                FPH: 30 * 60 * 60, // 每小时帧数（Frames Per Hour）
                FPD: 30 * 60 * 60 * 24, // 每天帧数（Frames Per Day）
                FPW: 30 * 60 * 60 * 24 * 7, // 每周帧数（Frames Per Week）
