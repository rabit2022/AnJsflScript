    ...
    export interface IEnumerable<T> {
        ...
        selectMany<TCollection, TResult>(
            collectionSelector: (
                element: T,
                index: number
            ) => { length: number; [x: number]: TCollection },
            resultSelector: (outer: T, inner: TCollection) => TResult
        ): IEnumerable<TResult>;
        ...
        zip<U, TResult>(
            second: { length: number; [x: number]: U },
            resultSelector: (first: T, second: U, index: number) => TResult
        ): IEnumerable<TResult>;
        ...
        join<TInner, TKey, TResult>(
            inner: { length: number; [x: number]: TInner },
            outerKeySelector: (outer: T) => TKey,
            innerKeySelector: (inner: TInner) => TKey,
            resultSelector: (outer: T, inner: TInner) => TResult,
            compareSelector?: (obj: T) => TKey
        ...
        partitionBy<TKey>(
            keySelector: (element: T) => TKey
        ): IEnumerable<IGrouping<TKey, unknown>>;
        ...
        firstOrDefault<TOther extends T>(
            predicate: (element: T, index: number) => element is TOther
        ): TOther | undefined;
        ...
        lastOrDefault<TOther extends T>(
            predicate: (element: T, index: number) => element is TOther
        ): TOther | undefined;
        ...
        singleOrDefault<TOther extends T>(
            predicate: (element: T, index: number) => element is TOther
        ): TOther | undefined;
        ...
        letBind<TResult>(
            func: (source: IEnumerable<T>) => TResult[]
        ): IEnumerable<TResult>;
