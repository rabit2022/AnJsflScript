    ...
    /** *** */ (function (modules) {
        ...
        /** *** */ [
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                if (
                    typeof _ === 'function' &&
                    typeof _.runInContext === 'function'
                ) {
            ...
            /***/ function (module, exports, __webpack_require__) {
                ...
                function wrapImmutable(func, cloner) {
                    return function () {
                        ...
                        const result = (args[0] = cloner.apply(
                            undefined,
                            args
                        ));
                ...
                function baseConvert(util, name, func, options) {
                    ...
                    const config = {
                        ...
                        immutable:
                            'immutable' in options ? options.immutable : true,
                    ...
                    function castFixed(name, func, n) {
                        if (
                            config.fixed &&
                            (forceFixed || !mapping.skipFixed[name])
                        ) {
                    ...
                    function iterateeAry(func, n) {
                        return overArg(func, (func) =>
                            typeof func === 'function' ? baseAry(func, n) : func
                        );
                    }
