define(function (require, exports, module) {
    ...
    var getDisposableStackInternalState =
        InternalStateModule.getterFor(DISPOSABLE_STACK);
    ...
    defineBuiltIns(DisposableStackPrototype, {
        ...
        use: function use(value) {
            addDisposableResource(
                getPendingDisposableStackInternalState(this),
                value,
                HINT
            );
            return value;
        ...
        move: function move() {
            ...
            getDisposableStackInternalState(newDisposableStack).stack =
                internalState.stack;
            internalState.stack = [];
            internalState.state = DISPOSED;
            if (!DESCRIPTORS) this.disposed = true;
    ...
    defineBuiltIn(
        ...
        DISPOSE,
        DisposableStackPrototype.dispose,
        { name: 'dispose' }
    );
