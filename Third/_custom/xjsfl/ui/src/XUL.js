define(["Utils","XULControl","XULEvent","XML","xjsfl"],
	...
	// constructor
		...
		XUL = function(title)
		{
			...
			// 	this.xml		= new XML(__WEBPACK_COMPATIBILITY_TEXT_PLUGIN_ABSOLUTE_PATH__('./config/xul/dialog.xul'));
				this.xml		= new XML(__WEBPACK_COMPATIBILITY_TEXT_PLUGIN_ABSOLUTE_PATH__("./xul/dialog.xul"));
			...
			// 	var xml			= new XML(__WEBPACK_COMPATIBILITY_TEXT_PLUGIN_ABSOLUTE_PATH__('./config/xul/controls.xul'));
				var xml			= new XML(__WEBPACK_COMPATIBILITY_TEXT_PLUGIN_ABSOLUTE_PATH__("./xul/controls.xul"));
