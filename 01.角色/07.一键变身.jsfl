...
require(["checkUtil", "elementUtil", "linqUtil", "frUtil", "selection", "sat", "graphics", "curve"],
    function (checkUtil, ele, linqUtil, frUtil, sel, sat, graphics, curve) {
        ...
        var MIDDLE_SHAPE_RADIUS = (function () {
            ...
            var [FRAME0_BEFORE_Element, FRAME0_AFTER_Element] = getBeforeAfterElement(_FRAME_0);
        ...
        function Main() {
            ...
            // 变身前
            var [FRAME1_BEFORE_Element, FRAME1_AFTER_Element] = getBeforeAfterElement(BEFORE_FRAME);
            ...
            // 变身后
            var [FRAME17_BEFORE_Element, FRAME17_AFTER_Element] = getBeforeAfterElement(AFTER_FRAME);
            ...
            // 变身完成
            var [FRAME18_BEFORE_Element, FRAME18_AFTER_Element] = getBeforeAfterElement(FINISH_FRAME);
