...
require(["checkUtil", "promptUtil", "linqUtil", "filterUtil", "curve", "frUtil", "Constants"],
    function (checkUtil, promptUtil, linqUtil, filterUtil, curve, frUtil, Constants) {
        ...
        function Main() {
            ...
            filterUtil.addBlurFilterToFrame(firstLayer, ALTER_POSITION_BLUR, BLUR_X, 0, "high");
