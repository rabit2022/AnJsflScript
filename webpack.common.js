...
module.exports = {
    ...
    resolve: {
        ...
        alias: {
            ...
            FolderTraverser: path.resolve(
                __dirname,
                "Third/custom/FolderTraverser/FolderTraverser"
            ),
            ...
            eventemitter3: path.resolve(
                __dirname,
                "Third/event/eventemitter3-5.0.1/eventemitter3"
            ),
            rxjs: path.resolve(__dirname, "Third/event/rxjs-7.8.2/rxjs.umd"),
            "circular-json": path.resolve(
                __dirname,
                "Third/json/circular-json-0.5.9/circular-json.amd"
            ),
            ...
            "path-browserify": path.resolve(
                __dirname,
                "Third/modules/path-browserify-1.0.1/path-browserify"
            ),
            "require-js": path.resolve(
                __dirname,
                "Third/modules/requirejs-2.3.7/require-js"
            ),
            ...
            "es6-collections": path.resolve(
                __dirname,
                "Third/polyfill/es6-collections-0.5.6/es6-collections"
            ),
            "es6-sham": path.resolve(
                __dirname,
                "Third/polyfill/es6-shim-0.35.4/es6-sham"
            ),
            "es6-shim": path.resolve(
                __dirname,
                "Third/polyfill/es6-shim-0.35.4/es6-shim"
            ),
            ...
            typedarray: path.resolve(
                __dirname,
                "Third/polyfill/typedarray-0.0.7/typedarray"
            ),
            "error-stack-parser": path.resolve(
                __dirname,
                "Third/stack/error-stack-parser-3.0.0/error-stack-parser"
            ),
            stackframe: path.resolve(
                __dirname,
                "Third/stack/stackframe-1.3.4/stackframe"
            ),
            linq: path.resolve(__dirname, "Third/utils/linq-4.0.3/linq"),
            lodash: path.resolve(__dirname, "Third/utils/lodash-4.17.21/lodash"),
            "sprintf-js": path.resolve(
                __dirname,
                "Third/utils/sprintf-js-1.1.3/sprintf-js"
            ),
            "fast-xml-parser": path.resolve(
                __dirname,
                "Third/xml/fast-xml-parser-5.0.9/fast-xml-parser"
            ),
            ...
            "es6-promise": path.resolve(
                __dirname,
                "Third/polyfill/es6-promise-4.6.8/es6-promise.auto"
            ),
            ...
            StrokeDefinitions: path.resolve(
                __dirname,
                "Core/flash/color/StrokeDefinitions"
            ),
            ElementAnim: path.resolve(
                __dirname,
                "Core/flash/Context/Element/ElementAnim"
            ),
            ElementChecker: path.resolve(
                __dirname,
                "Core/flash/Context/Element/ElementChecker"
            ),
            ElementOperation: path.resolve(
                __dirname,
                "Core/flash/Context/Element/ElementOperation"
            ),
            ElementQuery: path.resolve(
                __dirname,
                "Core/flash/Context/Element/ElementQuery"
            ),
            ElementTransform: path.resolve(
                __dirname,
                "Core/flash/Context/Element/ElementTransform"
            ),
            FrameChecker: path.resolve(
                __dirname,
                "Core/flash/Context/Frame/FrameChecker"
            ),
            FrameOperation: path.resolve(
                __dirname,
                "Core/flash/Context/Frame/FrameOperation"
            ),
            FrameQuery: path.resolve(__dirname, "Core/flash/Context/Frame/FrameQuery"),
            KeyFrameChecker: path.resolve(
                __dirname,
                "Core/flash/Context/KeyFrame/KeyFrameChecker"
            ),
            KeyFrameOperation: path.resolve(
                __dirname,
                "Core/flash/Context/KeyFrame/KeyFrameOperation"
            ),
            KeyFrameQuery: path.resolve(
                __dirname,
                "Core/flash/Context/KeyFrame/KeyFrameQuery"
            ),
            LayerChecker: path.resolve(
                __dirname,
                "Core/flash/Context/Layer/LayerChecker"
            ),
            LayerHierarchy: path.resolve(
                __dirname,
                "Core/flash/Context/Layer/LayerHierarchy"
            ),
            LayerOperation: path.resolve(
                __dirname,
                "Core/flash/Context/Layer/LayerOperation"
            ),
            LayerQuery: path.resolve(__dirname, "Core/flash/Context/Layer/LayerQuery"),
            LayerQueryEnhance: path.resolve(
                __dirname,
                "Core/flash/Context/Layer/LayerQueryEnhance"
            ),
            LibraryOperation: path.resolve(
                __dirname,
                "Core/flash/Context/library/LibraryOperation"
            ),
            ElementSelect: path.resolve(
                __dirname,
                "Core/flash/Context/selection/ElementSelect"
            ),
            FramesSelect: path.resolve(
                __dirname,
                "Core/flash/Context/selection/FramesSelect"
            ),
            FilterChecker: path.resolve(__dirname, "Core/flash/filter/FilterChecker"),
            FilterDefinitions: path.resolve(
                __dirname,
                "Core/flash/filter/FilterDefinitions"
            ),
            ...
            DrawParallelogram: path.resolve(
                __dirname,
                "Core/flash/graphics/DrawParallelogram"
            ),
            ...
            SymbolNameGenerator: path.resolve(
                __dirname,
                "Core/flash/Symbol/SymbolNameGenerator"
            ),
