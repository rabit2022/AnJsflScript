...
require(["require", "_exports", "checkUtil", "KeyFrameQuery", "os", "LayerSelect", "SoundChecker", "loglevel"], function (require, exports, checkUtil_1, KeyFrameQuery_1, os, LayerSelect_1, SoundChecker_1, log) {
    "use strict";
    ...
    function selectSoundLayers() {
        ...
        for (var i = 0; i < layers.length; i++) {
            var layer = layers[i];
            var layerSoundInfos = (0, SoundChecker_1.hasSound)(layers, layer);
