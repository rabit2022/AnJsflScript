...
function EditOuter(shadowCount: number) {
    function getAlpha(shadowCount: number, i: number) {
        // 20  4，10,8，5 16      80
        let MAX_ALPHA = 80;
...
function Main() {
    ...
    var symbolName = generateNameUseLast("一键残影_内部_");
    doc.convertToSymbol("graphic", symbolName, "center");

    EditInner();

    var symbolName = generateNameUseLast("一键残影_外部_");
    doc.convertToSymbol("graphic", symbolName, "center");
