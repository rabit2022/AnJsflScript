...
require(["require", "_exports", "checkUtil", "ElementChecker", "KeyFrameOperation", "ElementQuery", "ElementAnim", "ElementSelect"], function (require, exports, checkUtil_1, ElementChecker_1, KeyFrameOperation_1, ElementQuery_1, ElementAnim_1, ElementSelect_1) {
    "use strict";
    ...
    if (!(0, checkUtil_1.CheckSelection)(selection, "selectElement", "Not Zero", "请先在舞台上选中至少一个图形元件!")) {
        return;
    }
    ...
    function Main() {
        ...
        var newSelection = [];
        var selectedFrame;
        for (var _i = 0, selectedFrames_1 = selectedFrames; _i < selectedFrames_1.length; _i++) {
            selectedFrame = selectedFrames_1[_i];
            timeline.setSelectedFrames(selectedFrame.toArray());
            var layerIndex = selectedFrame.layerIndex, startFrame = selectedFrame.startFrame, endFrame = selectedFrame.endFrame;
            (0, KeyFrameOperation_1.convertToKeyframesSafety)(timeline, startFrame, curLayer);
            var selection_1 = doc.selection;
            var symbols_2 = selection_1.filter(ElementChecker_1.IsSymbol);
            if (symbols_2.length === 0)
                return;
            ...
            for (var _a = 0, symbols_1 = symbols_2; _a < symbols_1.length; _a++) {
                ...
                if (symbolFrameCount < FRAME_COUNT) {
                    ...
                    symbolTimeline.insertFrames(FRAME_COUNT - symbolFrameCount, true, symbolFrameCount);
