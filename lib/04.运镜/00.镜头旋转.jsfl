...
require(["checkUtil", "loglevel", "KeyFrameOperation", "promptUtil"],
    function(checkUtil, log, kfo, promptUtil) {
        ...
        function Main() {
            ...
            var rotation = parseNumber("输入旋转角度（-180~180）:", 0, "请输入合法的数字(-180~180)", {
                start: -180,
                end: 180,
                step: 1
            });
