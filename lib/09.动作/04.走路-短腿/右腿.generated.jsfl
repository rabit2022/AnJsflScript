// 这个文件由脚本 右腿.ts 自动生成，任何手动修改都将会被覆盖.
require(["require", "_exports", "checkUtil", "SymbolNameGenerator", "ElementSelect", "SAT", "KeyFrameOperation", "JSFLConstants", "EaseCurve", "lodash"], function (require, exports, checkUtil_1, SymbolNameGenerator_1, ElementSelect_1, SAT_1, KeyFrameOperation_1, JSFLConstants, EaseCurve_1, _) {
    ...
    if (!(0, checkUtil_1.CheckSelection)(selection, "selectElement", "Only one", "请选中 右腿 元件")) {
        return;
    }
    ...
    function Main() {
        ...
        var symbolName = (0, SymbolNameGenerator_1.generateNameUntilUnique)("一键走路_右腿静_");
        doc.convertToSymbol("graphic", symbolName, "center");
        symbolName = (0, SymbolNameGenerator_1.generateNameUseLast)("一键走路_右腿动_");
        doc.convertToSymbol("graphic", symbolName, "center");
