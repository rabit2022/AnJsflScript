...
require(['checkUtil', 'loglevel', 'libUtil', 'os', 'sprintf', 'selectionUtil'],
    function(checkUtil, log, libUtil, os, { sprintf }, selectionUtil) {
        ...
        function downloadFileFromWeb(fileUrl, localPath) {
            ...
            var powershellCommand = sprintf('powershell -Command "Invoke-WebRequest -Uri \'%s\' -OutFile \'%s\'"', fileUrl, localPath);
