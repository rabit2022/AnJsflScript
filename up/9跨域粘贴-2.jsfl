function changeHead() {
    ...
    var worldViewMatrixAnti = doc.viewMatrix;
    worldViewMatrixAnti.a = 1;
    worldViewMatrixAnti.b = 0;
    worldViewMatrixAnti.c = 0;
    worldViewMatrixAnti.d = 1;
    worldViewMatrixAnti.tx = 367.85;
    worldViewMatrixAnti.ty = 412.9;
    // worldViewMatrixAnti.tx = 0;
    // worldViewMatrixAnti.ty = 0;
